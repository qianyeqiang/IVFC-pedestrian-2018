...
(cl:defmethod stop_signal-val ((m <pedestrian>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pedestrian-msg:stop_signal-val is deprecated.  Use pedestrian-msg:stop_signal instead.")
  (stop_signal m))

(cl:ensure-generic-function 'min_dist-val :lambda-list '(m))
(cl:defmethod min_dist-val ((m <pedestrian>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pedestrian-msg:min_dist-val is deprecated.  Use pedestrian-msg:min_dist instead.")
  (min_dist m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<pedestrian>)))
  ...
  "99ebc65ada5fa753b6a8360661335b91")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'pedestrian)))
  "Returns md5sum for a message object of type 'pedestrian"
  "99ebc65ada5fa753b6a8360661335b91")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<pedestrian>)))
  ...
  (cl:format cl:nil "std_msgs/Header header~%int8 stop_signal~%float64 min_dist~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'pedestrian)))
  "Returns full string definition for message of type 'pedestrian"
  (cl:format cl:nil "std_msgs/Header header~%int8 stop_signal~%float64 min_dist~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
